...
getSenhaNum(){
  ...
  if (this.tSenhasPri.length > 0){
    console.log("Senhas mostradas")
    console.log(this.tSenhasPri)
    console.log(this.tSenhasE)
    console.log(this.tSenhasG)
  }
  else if (this.totalE == 1 && this.totalG == 1 && this.totalPri==1){
    console.log("Nenhuma senha foi registrada")
    console.log(this.tSenhasPri)
    console.log(this.tSenhasE)
    console.log(this.tSenhasG)
  }else{
  for(let i=0;i<this.senhasPri.length;i++){
      this.tSenhasPri.push(
        this.senhasPri[i].Ano+
        this.senhasPri[i].mes+
        this.senhasPri[i].Dia+
        this.senhasPri[i].Tipo+
        this.senhasPri[i].numero.toString().padStart(2,"0"))
  }
  for(let j=0;j<this.senhasE.length;j++){
    this.tSenhasE.push(
      this.senhasE[j].Ano+
      this.senhasE[j].mes+
      this.senhasE[j].Dia+
      this.senhasE[j].Tipo+
      this.senhasE[j].numero.toString().padStart(2,"0"))
}
for(let k=0;k<this.senhasG.length;k++){
  this.tSenhasG.push(
    this.senhasG[k].Ano+
    this.senhasG[k].mes+
    this.senhasG[k].Dia+
    this.senhasG[k].Tipo+
    this.senhasG[k].numero.toString().padStart(2,"0"))
}
console.log(this.tSenhasPri)
console.log(this.tSenhasE)
console.log(this.tSenhasG)
...
/*
fichaPri = this.senhasPri.filter((ficha) =>{
ficha.numero;
ficha.Ano;
ficha.Mês;
ficha.Dia;
...
fichaG = this.senhasG.filter((fichag) =>{
  fichag.numero;
  fichag.Ano;
  fichag.Mês;
  fichag.Dia;
...
fichaE =this.senhasE.filter((fichae)=>{
  fichae.numero;
  fichae.Ano;
  fichae.Mês;
  fichae.Dia;
